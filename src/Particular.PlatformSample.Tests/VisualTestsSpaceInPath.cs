...
public class VisualTestsSpaceInPath
{
    Task launcherTask;
    ...
    public async Task Setup()
    {
        ...
        if (Environment.GetEnvironmentVariable("CI") == "true")
        {
            ...
            var dataDir = Path.Combine(runnerTemp, "browser-testing with spaces");
    ...
    [Test(Description = "Checks that ServicePulse is connected to ServiceControl and the endpoints are being monitored when there is a space in the path to the assemblies")]
    ...
    [Test(Description = "Checks the monitoring page functionality when there is a space in the path to the assemblies")]
